...
const Navbar = ({ onScrollTo }) => {
  ...
  return (
    <motion.nav
      ...
      className=" py-4  backdrop-blur-md w-full max-w-screen-xl mx-auto px-4 md:px-4 md:py-3 flex justify-center md:justify-between gap-10 border border-gray-400 bg-white/10  items-center rounded-lg"
    >
