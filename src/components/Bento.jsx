  ...
  return (
    <>
      <div className={gridClassName}>
        {isMobile && (
          <div className="block md:hidden ml-2 shiny-gradient items-center backdrop-blur-lg bg-white/10 p-4 rounded-2xl gap-3 mb-4 w-full max-w-xs mx-auto text-center">
            <img
              src={logo}
