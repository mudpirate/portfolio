...
const MobileNotice = ({ isVisible }) => {
  ...
  return (
    <div className="fixed bottom-1 left-4 right-4 bg-black/80 backdrop-blur-md text-white p-2 rounded-xl border border-white/20 shadow-lg z-50 animate-fade-up">
